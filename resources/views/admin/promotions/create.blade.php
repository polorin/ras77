...
<head>
    ...
    <title>Tambah Promosi - Admin Panel</title>
        ...
        <div class="py-8 px-4">
            <nav class="mb-6">
                <ol class="flex text-sm text-gray-600">
                    ...
                    <li class="mx-2">/</li>
                    <li class="text-gray-900 font-semibold">Tambah</li>
                </ol>
            </nav>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                ...
                <p class="text-gray-600">Lengkapi informasi promosi yang akan ditampilkan pada halaman publik.</p>
            </div>
